...
public class gui extends JFrame  {
	...
	private void init(){
		...
		String[] chooseSet = {"./data/flow0901.txt","./data/flow0902.txt","./data/flow0903.txt","./data/flow0904.txt","./data/flow0905.txt",
				"./data/flow0906.txt","./data/flow0907.txt","./data/meanflow.txt","./data/flow0908_guess.txt","./data/Allmeanflow_2.txt",
				"./data/round2_0901.txt","./data/round2_0902.txt","./data/round2_0903.txt","./data/round2_0904.txt",
				"./data/round2_0905.txt","./data/round2_0906.txt","./data/round2_0907.txt"};
		...
		JButton jb6 = new JButton("ReStart");
		jb6.setBounds(0, 0, 100, 30);
	...
	static private final class WorldPanel extends JPanel{
		...
		public void paint( Graphics   origin_g )
	    {
			...
			g.drawString(new String(JudgeTxt.substring(7)), 16, 16);
	...
	private static final class RestartAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
        	System.out.println("Button down: ReStart");
            System.out.flush();
	            ...
	            while(runtim>0)
	    		 {
	    			...
	    			//System.out.println(_trafficFlow);
